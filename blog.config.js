...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'BURA SUMMIT', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的物流人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://barusummit.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '跨境物流,美国海外仓,Amazon直送,一件代发,退货处理,博客', // 网站关键词 英文逗号隔开
